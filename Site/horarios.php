...
></df-messenger>
  ...
  <section class="main" id="pages" style="height: 220px">
    <div class="page-title overlay">
      <img src="https://www.slidesplash.com/static/assets/images/historia/horario.jpg" alt="" width="100%" height="220px">
    </div>
  </section>
          ...
          <div class="tab-content active" id="tabGeral">
            <div class="table-container">
              <table>
                <tr>
                  <th>Dia</th>
                  <th id="aberturaGeral">Hora de Abertura</th>
                  <th id="fechoGeral">Hora de Fecho</th>
                </tr>
                <!-- As linhas da tabela serão preenchidas dinamicamente -->
              </table>
            </div>
          </div>
          <div class="tab-content" id="tabEscolas">
            <div class="table-container">
              <table>
                <tr>
                  <th>Dia</th>
                  <th id="aberturaEscolas">Hora de Abertura</th>
                  <th id="fechoEscolas">Hora de Fecho</th>
                </tr>
                <!-- As linhas da tabela serão preenchidas dinamicamente -->
              </table>
            </div>
