...
></df-messenger>
  ...
  <section class="main" id="pages" style="height: 220px">
    <div class="page-title overlay">
      <img src="https://www.slidesplash.com/static/assets/images/banners/banner-emprego.png" alt="">
    </div>
  </section>

  <section class="horarios">
    <div class="container-fluid" style="margin-bottom: 100px; width: 100%">
      <div class="col-md-12 pad80">
        <h2 class="section-title">Notícias</h2>
        <br><br>


        <?php include './noticias/mostrarNoticias.php'; ?>
        ...
        <script>
          $(document).ready(function () {
            $('.subscribe-btn').click(function () {
              ...
              $.ajax({
                url: './newsletter/verificar_sessao.php',
                type: 'POST',
                success: function (response) {
                  if (response === 'sessao_iniciada') {
                    // Se a sessão estiver iniciada, atualizar o atributo 'newsletter' na base de dados
                    $.ajax({
                      url: './newsletter/atualizar_newsletter.php',
                      type: 'POST',
                      success: function () {
                    ...
                    window.location.href = './loja-online/login.html?redirect=' + encodeURIComponent(window.location.href);
                  }
                }
              });
            });
      ...
      <button class="btn subscribe-btn">Fica a par das notícias
