...
<body>
  ...
  <section class="main" id="pages" style="height: 200px">
    <div class="page-title overlay">
      <img src="https://www.slidesplash.com/static/assets/images/banners/banner-contatos.png" alt="">
    </div>
    <br>
  </section>
  ...
  <section id="contact">
    ...
    <div class="container main-content">
      <div class="text-center" id="mensagem_sucesso" style="color: green; margin-top: -50px; margin-bottom: 30px;">
      </div>
      <div class="text-center" id="mensagem_erro" style="color: red; margin-top: -50px; margin-bottom: 30px;"></div>
      <div class="col-md-12">
        <br>
        <br>
        <h2 class="section-title">Entra em contacto connosco!</h2>
        <div class="col-md-6" style="width: 100%;margin-left: 25%">
          <form id="contact-form" method="post" action="enviar_mail_contact.php">
            <input class="form-control input-box" type="text" id="nome" name="nome" placeholder="Nome completo" required
              style="width: 50%"><br><br>
            <input class="form-control input-box" type="email" id="email" name="email" placeholder="Endereço de Email"
              required style="width: 50%"><br><br>
            <input class="form-control input-box" type="tel" id="telemovel" name="telemovel"
              placeholder="Número de telemóvel" required pattern="(91|92|93|96)[0-9]{7}"
              title="Por favor, insira um número de 9 dígitos que comece com 91, 92, 93 ou 96."
              style="width: 50%"><br><br>
            <input class="form-control input-box" type="text" id="assunto" name="assunto" placeholder="Assunto" required
              style="width: 50%"><br><br>
            <textarea class="form-control input-box" id="mensagem" name="mensagem" rows="4"
              placeholder="Escreva a sua mensagem..." required
              style="height: 150px; width: 50%; resize: none;"></textarea><br><br>
            <button id="submit-button" class="btn" type="submit" style="margin-left: 18%;">Submeter</button>
        </div>
        </form>
      </div>
    </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      if (urlParams.has('error')) {
        erro.innerText = decodeURIComponent(urlParams.get('error'));
    ...
    document.getElementById('contact-form').addEventListener('submit', function (event) {
      ...
      var sucesso = document.getElementById('mensagem_sucesso');

      // Se a validação passar, exibe a mensagem de sucesso
      sucesso.innerText = 'Recebido, entraremos em contacto consigo brevemente!';
