...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/alugueres.css">
</head>
...
></df-messenger>
  ...
  <section class="alugueres">
    <div class="container-fluid">
      <div class="col-md-12 pad80">
        <h2 class="section-title">Alugueres</h2>
      </div>
    </div>
  </section>
  ...
  <div id="rentModal" class="modal">
    <div class="modal-content">
      ...
      <form id="rentForm">
        ...
        <div class="form-group">
          <label for="startTime">Data/Hora de Início:</label>
          <input type="date" id="startDate" name="startDate">
          <input type="time" id="startTime" name="startTime" step="1800">

        </div>
        <div class="form-group">
          <label for="endTime">Data/Hora de Fim:</label>
          <input type="date" id="endDate" name="endDate">
          <input type="time" id="endTime" name="endTime" step="1800">
        </div>
        <div class="form-group">
        ...
        <input type="hidden" id="isRental" name="isRental" value="true">
  ...
  <script src="js/alugueres.js"></script>
</body>